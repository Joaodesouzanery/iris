...
const mainMenu = [
  ...
  { icon: FileText, label: "Deliberações", href: "/dashboard" },
  { icon: MonitorDot, label: "Monitor de Reuniões", href: "/dashboard" },
  { icon: Users, label: "Diretores", href: "/dashboard" },
  { icon: Scale, label: "Jurimetria", href: "/dashboard" },
  { icon: ShieldAlert, label: "Auditoria Forense", href: "/dashboard" },
  { icon: Upload, label: "Upload de PDFs", href: "/upload" },
];
...
function SidebarSection({
  ...
  title: string;
  items: Array<{ icon: React.ElementType; label: string; active?: boolean; href?: string }>;
}) {
  return (
    <div className="mb-6">
